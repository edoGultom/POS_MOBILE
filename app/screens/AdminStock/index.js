                    ...
                    <>
                        <View style={[styles.container]}>
                            <View style={{
                                ...
                                <Text style={{ fontFamily: FONTFAMILY.poppins_light, fontSize: FONTSIZE.size_12, width: windowWidth / 5, color: COLORS.primaryWhiteHex }}>Stok Masuk</Text>
                                <Text style={{ fontFamily: FONTFAMILY.poppins_light, fontSize: FONTSIZE.size_12, width: windowWidth / 5, color: COLORS.primaryWhiteHex }}>Stok Keluar</Text>
                            ...
                            {data.map((item, idx) => {
                                return (
                                    <View key={item.nama_barang} style={{
                                        ...
                                        <Text style={{ fontFamily: FONTFAMILY.poppins_light, fontSize: FONTSIZE.size_12, width: windowWidth / 5, color: COLORS.primaryWhiteHex }}>{item.masuk > 0 ? `+${item.masuk}` : item.masuk}</Text>
