...
import TableReportPenjualan from '../../component/TableReportPenjualan'

const AdminReportPenjualan = ({ navigation }) => {
    ...
    const submitFilter = () => {
        ...
        if (dateStart && dateEnd) {
            url = `/report/penjualan-by-date-range`
            data = {
                start,
                end
            }
        } else if (checked.value !== '') {
            url = `/report/penjualan-by-date`
            data = {
                date: checked.value
            }
        } else {
    ...
    return (
        <View style={styles.ScreenContainer}>
            ...
            <HeaderBar title="Laporan Penjualan" onBack={() => navigation.goBack()} />
            <View style={{
                marginTop: 20,
            ...
            {/* TABLE */}
            {data ? (
                <TableReportPenjualan data={data} />
            ) : (
...
export default AdminReportPenjualan
